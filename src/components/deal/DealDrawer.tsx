          ...
          <div style={{ padding: '12px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
              <div style={{ flex: 1, minWidth: 0 }}>
                {brand && <div style={{ fontSize: 9, fontWeight: 700, color: bc, marginBottom: 1 }}>{brand.name}</div>}
                <div style={{ fontSize: 12, fontWeight: 700, color: '#0f172a', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{store?.name}</div>
              </div>
            ...
            <div style={{ marginBottom: 10 }}>
              <div style={{ fontSize: 8, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', marginBottom: 3 }}>MAGASIN</div>
              <div style={{ border: '1px solid #e2e8f0', borderRadius: 5, padding: 6, background: '#f8fafc', fontSize: 10 }}>
            ...
            <div style={{ marginBottom: 10 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 3 }}>
                <div style={{ fontSize: 8, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase' }}>CONTACTS</div>
                ...
                <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 5, padding: 6 }}>
                  {[['Civilité', 'civility'], ['Nom', 'name'], ['Dir.', 'directeur'], ['Tél', 'contactCalling'], ['Email', 'dealEmail']].map(([label, key]) => (
                    <div key={key} style={{ marginBottom: 5 }}>
                      <label style={{ fontSize: 8, color: '#64748b', display: 'block', marginBottom: 1, fontWeight: 600 }}>{label}</label>
                      {key === 'civility' ? (
            ...
            {deal.jobOffers && deal.jobOffers.length > 0 && (
              <div style={{ marginBottom: 10 }}>
                <div style={{ fontSize: 8, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', marginBottom: 3 }}>OFFRES</div>
            ...
            <div style={{ marginBottom: 10 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 3 }}>
                <div style={{ fontSize: 8, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase' }}>COMMERCIAL</div>
              ...
              {editCommercial ? (
                <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 5, padding: 6 }}>
                  <div style={{ marginBottom: 5 }}>
                    <label style={{ fontSize: 8, color: '#64748b', display: 'block', marginBottom: 1, fontWeight: 600 }}>Valeur €</label>
                  ...
                  <div style={{ marginBottom: 5 }}>
                    <label style={{ fontSize: 8, color: '#64748b', display: 'block', marginBottom: 1, fontWeight: 600 }}>DEMO</label>
            ...
            {/* ASSIGNÉ */}
            <div>
              <div style={{ fontSize: 8, fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', marginBottom: 3 }}>ASSIGNÉ</div>
